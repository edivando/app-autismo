...
class InstrumentsGameScene: BackgroundScene {
    ...
    override func didMoveToView(view: SKView) {
        ...
        var numberOfInstruments:UInt32  = 8
        ...
        let randomNumber = Int(arc4random_uniform(numberOfInstruments))
        ...
        for j in 0 ... numberOfInstruments - 1 {
            let node = SKSpriteNode(imageNamed: shuffledImages[0])
            if numberOfInstruments == 8{
